...
import coscholar4 from '../images/iloveimg-converted/IMG_5314.jpg'
import coscholar3 from '../images/iloveimg-converted/coscholar3.JPG'
import coscholar2 from '../images/iloveimg-converted/IMG_5307.jpg'
import coscholar1 from '../images/iloveimg-converted/IMG_5314.jpg'

function Coactivities() {
  return (
    <div>
    <div className='bg-all'>
      <div style={{padding:'10vw',fontSize:'1.2vw', color:'white', }}>
              <h1 ><span>Co-Scholistic Activities</span></h1>
      ...
      <h1 style={{textAlign:'center' , padding:'2vw'}}>Co-Scholistic Activities</h1>
      ...
      <div className='house-div2-img' >
          <img src={coscholar1} alt="" />
          <img src={coscholar2} alt="" />
          <img src={coscholar3} alt="" />
          <img src={coscholar4} alt="" />
      </div>
      </div>
